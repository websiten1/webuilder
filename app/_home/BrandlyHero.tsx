...
function ClientIcon({ type }: { type: IconType }) {
  ...
  switch (type) {
    ...
    case "clinici":
      return (
        <svg {...base}>
          <circle cx="16" cy="16" r="10.6" fill="none" stroke={ICON_GREEN} strokeWidth="2.35" />
          <path
            fill="none"
            stroke={ICON_GREEN}
            strokeWidth="2.35"
    ...
    case "startup":
      return (
        <svg {...base}>
          <path fill={ICON_GREEN} d="M5.94 29.84 25.96 29.95 24.54 27.54 21.42 27.21 19.73 25.13 18.14 25.46 17.21 27.1 15.79 26.5 14.42 27.38 13.66 25.57 11.52 25.24 10.21 27.38 7.75 27.54Z" />
          <path fill={ICON_GREEN} d="M13.27 6.21 12.4 10.2 12.73 18.02 13.38 18.13 13.82 19.12 17.92 19.12 19.01 18.08 19.4 10.8 18.52 6.27 15.62 6.76Z" />
          <path fill={ICON_GREEN} d="M11.74 14.47 10.26 15.84 11.25 20.81 12.23 18.68Z" />
          <path fill={ICON_GREEN} d="M20.05 14.47 19.56 18.57 20.55 20.81 21.59 15.89Z" />
          <path fill={ICON_GREEN} d="M13.6 5.39 15.08 5.94 17.1 5.88 18.19 5.55 17.54 4.24 15.9 2 14.64 3.59Z" />
          <path fill={ICON_GREEN} d="M13.66 20.1 18.25 20.1 18.09 19.61 13.82 19.61Z" />
          <path fill={ICON_GREEN} d="M14.31 20.48 14.04 20.7 14.04 23.27 14.2 23.44 14.48 23.44 14.69 23.22 14.69 20.76 14.53 20.54Z" />
          <path fill={ICON_GREEN} d="M15.79 21.74 15.57 21.96 15.57 24.91 15.68 25.08 16.01 25.13 16.23 24.91 16.23 21.96 16.12 21.8Z" />
          <path fill={ICON_GREEN} d="M17.43 20.48 17.16 20.59 17.1 20.76 17.1 23.22 17.32 23.44 17.59 23.44 17.76 23.22 17.76 20.76 17.65 20.54Z" />
          <path fill={ICON_GREEN} d="M15.51 7.63 16.28 7.63 17.1 7.96 17.87 8.73 18.19 9.77 17.76 11.24 16.39 12.17 15.41 12.17 14.59 11.79 13.82 10.91 13.6 10.15 13.71 9.16 14.09 8.51Z" />
          <path fill={ICON_GREEN} d="M15.73 13.81 16.06 13.81 16.28 14.03 16.28 18.3 16.01 18.57 15.68 18.52 15.51 18.3 15.51 14.03Z" />
        </svg>
      );
  }
}
